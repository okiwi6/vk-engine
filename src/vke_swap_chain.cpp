...
VkResult VkeSwapChain::submitCommandBuffers(
...
VkSurfaceFormatKHR VkeSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR VkeSwapChain::chooseSwapPresentMode(
    ...
    #else
      throw std::runtime_error("no sync method selected");
    #endif
